...
export default { rastrearEncomendas, dafontDownload, dafontSearch, xvideosPorno, pensador, dicionarioNome, XvideosSearch, XvideosDL, buscarMenoresPrecos, XnxxDL, XnxxSearch };